...
#couchbase-cli node-init -c 192.155.206.162:8091 --node-init-data-path=/tmp/data --node-init-data-path=/tmp/index -u altoros -p changeme
...
echo 'create bucket'
#couchbase-cli bucket-create -c 192.155.206.162:8091 --bucket=default --bucket-type=couchbase --bucket-port=11222 --bucket-ramsize=200 --bucket-replica=1 -u altoros -p changeme
