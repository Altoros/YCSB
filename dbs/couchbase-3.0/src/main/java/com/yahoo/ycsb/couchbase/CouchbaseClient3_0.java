...
public class CouchbaseClient3_0 extends MemcachedCompatibleClient {
    ...
    public void init() throws DBException {
        try {
            ...
            couchbaseClient = createMemcachedClient();
    ...
    protected CouchbaseClient createCouchbaseClient() throws Exception {
        ...
        String hosts = couchbaseConfig.getHosts();
        if (hosts == null) {
